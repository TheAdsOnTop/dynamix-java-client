...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Dynamix.FileMetadata = factory(root.Dynamix.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('uploadedByUserProfileRid')) {
        obj['uploadedByUserProfileRid'] = ApiClient.convertToType(data['uploadedByUserProfileRid'], 'String');
      }
    }
    return obj;
  }
  ...
  /**
   * @member {String} uploadedByUserProfileRid
   */
  exports.prototype['uploadedByUserProfileRid'] = undefined;
