...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Dynamix.DynamixCreditApi();
  });
  ...
  describe('DynamixCreditApi', function() {
    ...
    describe('checkBalance', function() {
      it('should call checkBalance successfully', function(done) {
        //uncomment below and update the code to test checkBalance
        //instance.checkBalance(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
