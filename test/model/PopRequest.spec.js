...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Dynamix.PopRequest();
  });
  ...
  describe('PopRequest', function() {
    it('should create an instance of PopRequest', function() {
      // uncomment below and update the code to test PopRequest
      //var instane = new Dynamix.PopRequest();
      //expect(instance).to.be.a(Dynamix.PopRequest);
    });
    ...
    it('should have the property impressionsData (base name: "impressionsData")', function() {
      // uncomment below and update the code to test the property impressionsData
      //var instane = new Dynamix.PopRequest();
      //expect(instance).to.be();
    });
