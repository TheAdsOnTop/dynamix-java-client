...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Dynamix.KeyedItemObject();
  });
  ...
  describe('KeyedItemObject', function() {
    it('should create an instance of KeyedItemObject', function() {
      // uncomment below and update the code to test KeyedItemObject
      //var instane = new Dynamix.KeyedItemObject();
      //expect(instance).to.be.a(Dynamix.KeyedItemObject);
    });
