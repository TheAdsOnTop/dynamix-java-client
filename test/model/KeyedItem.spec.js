...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Dynamix.KeyedItem();
  });
  ...
  describe('KeyedItem', function() {
    it('should create an instance of KeyedItem', function() {
      // uncomment below and update the code to test KeyedItem
      //var instane = new Dynamix.KeyedItem();
      //expect(instance).to.be.a(Dynamix.KeyedItem);
    });
