...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Dynamix.PagedResponsePublisher();
  });
  ...
  describe('PagedResponsePublisher', function() {
    it('should create an instance of PagedResponsePublisher', function() {
      // uncomment below and update the code to test PagedResponsePublisher
      //var instane = new Dynamix.PagedResponsePublisher();
      //expect(instance).to.be.a(Dynamix.PagedResponsePublisher);
    });
