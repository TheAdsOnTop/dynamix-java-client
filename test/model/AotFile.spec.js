...
(function(root, factory) {
  ...
  describe('AotFile', function() {
    it('should create an instance of AotFile', function() {
      // uncomment below and update the code to test AotFile
      //var instane = new Dynamix.AotFile();
      //expect(instance).to.be.a(Dynamix.AotFile);
    });
