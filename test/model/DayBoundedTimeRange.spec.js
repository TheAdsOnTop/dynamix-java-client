...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Dynamix.DayBoundedTimeRange();
  });
  ...
  describe('DayBoundedTimeRange', function() {
    it('should create an instance of DayBoundedTimeRange', function() {
      // uncomment below and update the code to test DayBoundedTimeRange
      //var instane = new Dynamix.DayBoundedTimeRange();
      //expect(instance).to.be.a(Dynamix.DayBoundedTimeRange);
    });
