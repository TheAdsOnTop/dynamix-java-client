...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Dynamix.PagedRequest();
  });
  ...
  describe('PagedRequest', function() {
    it('should create an instance of PagedRequest', function() {
      // uncomment below and update the code to test PagedRequest
      //var instane = new Dynamix.PagedRequest();
      //expect(instance).to.be.a(Dynamix.PagedRequest);
    });
