...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Dynamix.PagedSearchQuery();
  });
  ...
  describe('PagedSearchQuery', function() {
    it('should create an instance of PagedSearchQuery', function() {
      // uncomment below and update the code to test PagedSearchQuery
      //var instane = new Dynamix.PagedSearchQuery();
      //expect(instance).to.be.a(Dynamix.PagedSearchQuery);
    });
