...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Dynamix.AdWithProbability();
  });
  ...
  describe('AdWithProbability', function() {
    it('should create an instance of AdWithProbability', function() {
      // uncomment below and update the code to test AdWithProbability
      //var instane = new Dynamix.AdWithProbability();
      //expect(instance).to.be.a(Dynamix.AdWithProbability);
    });
